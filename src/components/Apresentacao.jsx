      ...
      <FadeInSection>
        <div className="max-w-6xl mx-auto px-4 flex flex-col-reverse md:flex-row items-center justify-between gap-8 md:gap-10">
          ...
          <div className="w-full text-center md:text-left">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight text-red-400 min-h-[48px] sm:min-h-[60px] mt-2">
              {mostrarCargos && (
                <TypeAnimation
                  sequence={[
                    'Estagiário de T.I',
          ...
          <div className="w-full flex justify-center md:justify-end items-center">
            <img
              ...
              alt="lucas-perfil"
              className="w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 object-cover rounded-full shadow-xl border-4 border-white" 
            />
          </div>
